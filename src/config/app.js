import {
  ...
  SLIP_TOTAL,
  TITLE_REVEAL_END,
} from "./config/constants.js?v=20260911-1";
import { SECTIONS } from "./config/sections.js?v=20260911-1";
import { FILM_CONTENT_PAGES } from "./config/film-content.js?v=20260910-1";
import { FESTIVAL_CONTENT_PAGES } from "./config/festival-content.js?v=20260911-1";
import { GAME_CONTENT_PAGES } from "./config/game-content.js?v=20260910-1";
...
import { SILK_ROAD_CONTENT_PAGES } from "./config/silk-road-content.js?v=20260910-1";
...
import { createSlipSections } from "./features/booklet/slip-factory.js?v=20260905-5";
import { createSectionContentController } from "./features/booklet/section-content-controller.js?v=20260911-1";
import { createContentSliderController } from "./features/booklet/content-slider-controller.js?v=20260911-1";
...
import { createGameContentController } from "./features/booklet/game-content-controller.js?v=20260910-1";
